...
class CardDetails extends Component {
  ...
  static Button = ({ icon, title, onClick }) => (
  ...
  static CardHeader = ({ name, close, onChange, handleCardNameMutation, cardId }) => (
    ...
    return (
      <div className="sidebar-buttons">
        ...
        <div className="section">
          ...
          <CardDetails.Button icon="" title="Delete" onClick={actions.deleteCard} />
        </div>
        <Button
          name="Share and more..."
          background="none"
  ...
  render() {
    let { open, card, closeCardDetails, actions } = this.props;
    let { descriptionIsActive } = this.state;


    let cardButtonActions = {
      deleteCard: () => actions.buttons.deleteCard({cardId: card.shortid, listId: card.listId}),
    };
      ...
      return (
        <div className="card-details-wrapper">
          <div ref={cardDetails => this.cardDetails = cardDetails} className="card-details">
            <CardDetails.CardHeader close={closeCardDetails} 
