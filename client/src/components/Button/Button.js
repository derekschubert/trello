...
export default class Button extends Component {
    ...
    determineStyle = () => {
        let { width, height, extraStyles, icon } = this.props;
        let style = {
            width,
            height,
            ...extraStyles,
        ...
        if (icon) style.gridTemplateColumns = '32px auto';
    ...
    render() {
        let { fontColor, iconWrapperSize, refId, href, icon, name, weight, fontSize, iconMaskPosition, iconColor, iconSize, height } = this.props;
        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    {name && <span style={{fontWeight: weight, fontSize, color: fontColor, lineHeight: height}} className="name">{name}</span>}
                </a>
